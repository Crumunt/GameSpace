...
$data = $userView->getProducts(0, 12);
...
<div class="container mt-5">
      ...
      ?>
        <div class="carousel-item <?= ($carouselCounter == 1) ? 'active' : '' ?>">
          ...
          <div class="carousel-caption top-0 mt-lg-4 mt-sm-0">
            ...
            <p class="fs-1 fs-sm-5 mt-lg-5 mt-sm-4 fw-bolder text-capitalize"><?= $carouselItem['product_name'] ?></p>
  ...
  <div class="card my-5 discount__card shadow" style="">
    <div class="row g-0">
      <div class="col-md-4">
        <img src=<?= "{$banner__product[0]['product_thumbnail']}" ?> class="img-fluid rounded-start" alt="...">
      </div>
      <div class="col-md-8">
