...
(1, 1, 'Whitebeard', 1, 3, 1, 12.99, '2024-04-20', 'Preparing to ship', 'Grandline', NULL);
...
(3, 'Kingdom Come: Deliverance', '<p>You&#39;re Henry, the son of a blacksmith. Thrust into a raging civil war, you watch helplessly as invaders storm your village and slaughter your friends and family. Narrowly escaping the brutal attack, you grab your sword to fight back. Avenge the death of your parents and help repel the invading forces!</p>', 'https://media.rawg.io/media/games/d8f/d8f3b28fc747ed6f92943cdd33fb91b5.jpeg', 'a:6:{i:0;s:80:\"https://media.rawg.io/media/screenshots/57a/57a10b6c897bc2c21666f4a9bcfdefcc.jpg\";i:1;s:80:\"https://media.rawg.io/media/screenshots/8bc/8bc2d7c3039918e39c0d0e35f2abbe93.jpg\";i:2;s:80:\"https://media.rawg.io/media/screenshots/cdd/cdd3304a7c3507d221ff475eb50358c8.jpg\";i:3;s:80:\"https://media.rawg.io/media/screenshots/c48/c48e46fe5bbe9573acd34b42d955eef8.jpg\";i:4;s:80:\"https://media.rawg.io/media/screenshots/1ad/1adaff50796645d8914156a69449b6c1.jpg\";i:5;s:80:\"https://media.rawg.io/media/screenshots/a1e/a1e908e8b1ec42434fc9c4d0fcf6484c.jpg\";}', 12.99, 0, NULL),
...
(208, 'Astral Drifter', 'Astral Drifter is a fast-paced, rogue-lite action RPG where you explore procedurally generated space stations, collect powerful loot, and battle ruthless alien enemies. Each run throws you into a unique environment filled with challenging enemies, hidden secrets, and powerful upgrades. Master a variety of weapons and abilities as you fight your way through the depths of the station, uncovering the mysteries of a forgotten civilization and your own forgotten past.', 'product_thumbnail_637491.jpeg', 'a:5:{i:0;s:28:\"product_snapshot_756483.jpeg\";i:1;s:28:\"product_snapshot_160291.jpeg\";i:2;s:28:\"product_snapshot_390006.jpeg\";i:3;s:28:\"product_snapshot_422479.jpeg\";i:4;s:28:\"product_snapshot_886509.jpeg\";}', 19.99, 0, NULL),
...
(2, 'Test Signup', 'test@gmail.com', 'student', '2024-04-17 21:20:39'),
...
--
ALTER TABLE `tbl_product_categories`
  ADD CONSTRAINT `fk_category_id` FOREIGN KEY (`category_id`) REFERENCES `tbl_categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_productID` FOREIGN KEY (`product_id`) REFERENCES `tbl_products` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tbl_product_platforms`
--
ALTER TABLE `tbl_product_platforms`
  ADD CONSTRAINT `fk_platform_id` FOREIGN KEY (`platform_id`) REFERENCES `tbl_platforms` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `product_id` FOREIGN KEY (`product_id`) REFERENCES `tbl_products` (`id`) ON DELETE CASCADE;
COMMIT;
